...
const Help = () => {
  ...
  return (
    <div className="bg-gray-100 py-16">
      <button onClick={handleBack} className="text-blue-700 hover:text-blue-800 transition duration-200">
        <FaArrowLeft />
      </button>

      <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-lg p-10 md:p-14">
        {/* Header Section */}
        <header className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-blue-700">Welcome to Our Fundraising Platform</h1>
        ...
        <footer className="footer text-center mt-10">
          ...
          <p className="text-gray-700 mb-2">Rajasthan, India</p>
          <p className="text-gray-700 mt-6">Follow us on:</p>
